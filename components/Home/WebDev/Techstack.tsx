    ...
    return (
        <div>
            <div className='w-full gap-4 flex flex-col'>
                <div className=" bg-white px-5 py-1 rounded-lg flex flex-row gap-2 text-black text-3xl font-semibold bg-yellow uppercase border-b-2"
                ...
                <div className='flex mt-2 flex-row '>
                    ...
                    <p className='text-white italic ml-2'> C# | Typescript | Javascript | Html/Css</p>
                </div>

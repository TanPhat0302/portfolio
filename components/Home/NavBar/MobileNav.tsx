...
const MobileNav = ({showNav, closeNav}: Props) => {
  ...
  return (
    <div>
      ...
      {/* Nav Links */}
      <div className={`text-white ${navOpen} transform transition-all duration-200 fixed justify-center flex flex-col h-full
       w-[80%] sm:w-[60%] bg-[#0f0715] space-y-6 z-[10000]`}>
